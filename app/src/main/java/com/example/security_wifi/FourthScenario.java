...
public class FourthScenario extends ListActivity {
    ...
    static final String[] wifi_passwords =
            new String[]{"hope832", "", "hope832", "", "gsafjaslfk", "gfdlskafdla"};
    ...
    public void sendElapsedToServer() {
        ...
        Log.d("myTag", "took  " + elapsedSeconds + " time to complete scenario 4");
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("scenario 4 wifi", selectedValue + " " + selectedStrength);
        } catch (JSONException e) {
            e.printStackTrace();
        }

        try {
            jsonObject.put("scenario 4 time",elapsedSeconds);
        } catch (JSONException e) {
            e.printStackTrace();
        }
