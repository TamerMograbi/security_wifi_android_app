...
public class FifthScenario extends ListActivity {
    ...
    static final String[] wifi_passwords =
            new String[]{"months491", "", "months491", "", "gsafjaslfk", "gfdlskafdla"};
    ...
    public void sendElapsedToServer() {
        ...
        Log.d("myTag", "took  " + elapsedSeconds + " time to complete scenario 5");
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("scenario 5 wifi", selectedValue + " " + selectedStrength);
        } catch (JSONException e) {
            e.printStackTrace();
        }

        try {
            jsonObject.put("scenario 5 time",elapsedSeconds);
        } catch (JSONException e) {
            e.printStackTrace();
        }
